...
export const watchlist = pgTable(
  "watchlist",
  {
    ...
    userId: text("user_id")
      .notNull()
      .references(() => user.id, { onDelete: "cascade" }),
    assetId: text("asset_id").notNull(), // e.g., "bitcoin", "AAPL"
    assetType: text("asset_type").notNull(), // "crypto" | "stock"
    addedAt: timestamp("added_at").defaultNow().notNull(),
  },
  (table) => [
    index("watchlist_userId_idx").on(table.userId),
    // Prevent duplicate entries: one user can't add the same asset twice
...
// Update user relations to include watchlist
